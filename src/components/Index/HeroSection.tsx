      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-8 items-center">
          ...
          <div className="flex flex-col items-start space-y-6 lg:space-y-8 animate-in fade-in slide-in-from-left-8 duration-700">
            <Badge variant="outline" className="text-accent border-accent/30 bg-accent/5 px-4 py-1 rounded-full font-semibold tracking-wide uppercase text-xs">
            ...
            <div className="flex flex-col sm:flex-row gap-4 w-full sm:w-auto">
              <Button asChild size="lg" className="bg-accent hover:bg-accent/90 text-white font-bold h-14 px-8 text-lg rounded-xl shadow-lg shadow-accent/20 transition-all">
                <Link to="/contact">Get a Quote</Link>
              </Button>
              <Button asChild size="lg" variant="outline" className="bg-transparent border-white/40 hover:bg-white/10 text-white font-bold h-14 px-8 text-lg rounded-xl backdrop-blur-sm transition-all">
          ...
          <div className="relative animate-in fade-in slide-in-from-right-8 duration-700 delay-200">
            <div className="relative rounded-3xl overflow-hidden shadow-2xl border border-white/10 group">
              <img className="w-full aspect-[4/3] object-cover group-hover:scale-105 transition-transform duration-700" src="https://storage.googleapis.com/uxpilot-auth.appspot.com/gen_554c8de27d_52e918b99b1cf7a3.png" alt="Large professional printing workshop in Kenya with vibrant indoor signage and large format printers " />
            ...
            <div className="absolute -bottom-6 -left-6 sm:bottom-8 sm:left-8 bg-white p-4 rounded-2xl shadow-2xl border border-border flex items-center gap-4 max-w-[240px] animate-bounce-subtle">
              <div className="w-12 h-12 rounded-lg overflow-hidden flex-shrink-0">
                <img className="w-full h-full object-cover" src="https://storage.googleapis.com/uxpilot-auth.appspot.com/gen_63248d820b_ccc2f47ae3d0d110.png" alt="Corporate brand identity kit with business cards and stationery" />
              </div>
              <div>
                <p className="text-[10px] uppercase tracking-wider font-bold text-accent mb-0.5">Latest Project</p>
                <p className="text-sm font-extrabold text-primary leading-tight mb-1">Brand Identity Kit</p>
                <span className="inline-block px-2 py-0.5 rounded-full bg-emerald-100 text-emerald-700 text-[10px] font-bold">Completed</span>
              </div>
            </div>
